<template>
  <el-card class="product-card" shadow="hover">
    ...
    <div class="product-actions">
      ...
      <el-button v-if="showReport" size="small" type="danger" plain :disabled="product.status !== 'on_sale'" @click="$emit('report', product)">举报</el-button>
    </div>
  </el-card>
</template>
...
withDefaults(defineProps<{ product: Product; hideBuy?: boolean; showChat?: boolean; showReport?: boolean }>(), { hideBuy: false, showChat: false, showReport: false })
defineEmits<{ (e: 'detail', p: Product): void; (e: 'buy', p: Product): void; (e: 'chat', p: Product): void; (e: 'report', p: Product): void }>()
</script>
