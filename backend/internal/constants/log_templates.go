...
const (
	...
	LogProductReportSubmitSuccess     = "product report submit success: report_id=%d product_id=%d reporter=%d"
	LogProductReportSubmitDuplicate   = "product report submit duplicated: report_id=%d product_id=%d reporter=%d"
	LogProductReportSubmitFailed      = "product report submit failed: product_id=%d reporter=%d error=%v"
	LogProductReportTakeDownSuccess   = "product report take down success: report_id=%d product_id=%d admin=%d"
	LogProductReportRejectSuccess     = "product report reject success: report_id=%d admin=%d"
	LogProductReportHandleConflict    = "product report handle conflict: report_id=%d admin=%d action=%s"
)
